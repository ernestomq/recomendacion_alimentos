...
Para poder ejecutar este proyecto, se han indicado las librerías utilizadas junto con sus versiones en el archivo requirements.txt.
...
Por otro lado, la carpeta **faiss_index_BAAI** almacena los embeddings creados una vez realizada la lectura a partir del archivo **embeddings.py**.
